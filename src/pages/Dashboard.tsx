...
const Dashboard = () => {
  ...
  const bookedSlots = [
    { day: 0, time: 1, room: "A101", type: "lecture" },
    { day: 0, time: 3, room: "B204", type: "club" },
    { day: 1, time: 2, room: "C301", type: "lecture" },
    { day: 2, time: 0, room: "A101", type: "event" },
    { day: 2, time: 4, room: "D102", type: "club" },
    { day: 3, time: 1, room: "B204", type: "lecture" },
    { day: 3, time: 5, room: "A101", type: "event" },
    { day: 4, time: 3, room: "C301", type: "club" },
    { day: 4, time: 6, room: "D102", type: "lecture" },
  ];

  const getBookingColor = (type: string) => {
    switch(type) {
      case "lecture": return "bg-primary/20 border-primary/40 text-primary";
      case "club": return "bg-secondary/20 border-secondary/40 text-secondary";
      case "event": return "bg-accent/20 border-accent/40 text-accent";
        ...
        <div className="flex justify-between items-start mb-12 animate-fade-in">
          <div className="space-y-2">
            <h1 className="text-4xl md:text-5xl font-bold text-foreground">
              Hi, <span className="text-gradient">Rishi</span>!
            </h1>
                      ...
                      return (
                        <div
                          ...
                          className={`
                            ...
                            ${bookedSlot 
                              ? `${getBookingColor(bookedSlot.type)} border-2` 
